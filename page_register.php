...
$queryError = getFlashMessage('QueryError');;
?>
<!DOCTYPE html>
<html lang="en">
<head>
                            ...
                            <div class="card p-4 rounded-plus bg-faded">
                                ...
                                <form id="js-login" novalidate="" action="registration.php" method="post">
                                    <div class="form-group">
                                        ...
                                        <input name="email" id="emailverify" class="form-control"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="password" id="userpassword" class="form-control" placeholder=""
                                               required>
                                        <div class="invalid-feedback">Заполните поле.</div>
                                    </div>
